...
/*
  ...
  {"ssl-crlpath", OPT_SSL_KEY, 
   ...
   0, 0, 0, 0, 0, 0},
  {"ssl-passphrase", OPT_SSL_PASSPHRASE_CMD,
    "Certificate key passphrase cpmmand (implies --ssl).",
   &opt_ssl_passphrase_cmd, &opt_ssl_passphrase_cmd, 0, GET_STR, REQUIRED_ARG,
   0, 0, 0, 0, 0, 0},
